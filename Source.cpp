...
int main()
{
    ...
    unsigned int diffuseMap = loadTexture("resources/textures/space/7.jpg");
    unsigned int specularMap = loadTexture("resources/textures/space/7.jpg");
    unsigned int cylinderTexture = loadTexture("resources/textures/space/7.jpg");
    unsigned int sphereTexture = loadTexture("resources/textures/space/5.jpg");
